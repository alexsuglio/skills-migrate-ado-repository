...
1. Under `Scopes`, select `Custom defined` and choose the following scopes:
   ...
   - **Identity**: Read (required for migration tools)
    ...
    <img width="600" alt="Show all scopes link at the bottom of the token scopes view" src="https://github.com/alexsuglio/skills-migrate-ado-repository/blob/main/.github/images/show-all-scopes-link.png?raw=true" />
